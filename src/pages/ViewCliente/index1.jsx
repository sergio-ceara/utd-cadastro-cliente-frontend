...
function ViewCliente() {
    ...
    return (
        ...
        <div className={styles.container}>
            {/* Tabela para visualização em telas maiores */}
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    {clientes.map(cliente => (
                        <tr key={cliente.id}>
                            ...
                            <td className={styles.email} data-label="Endereco">{cliente.email}</td>
                ...
                {/* Exibição dos clientes como bloco para telas menores */}
                {clientes.map(cliente => (
